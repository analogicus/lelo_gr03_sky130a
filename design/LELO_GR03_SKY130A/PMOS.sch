...
N 310 -300 310 -240 {lab=#net1}
N 270 -300 270 -210 {lab=#net1}
N 310 -210 340 -210 {lab=VDD_1V8}
N 340 -600 340 -210 {lab=VDD_1V8}
N 100 -600 340 -600 {lab=VDD_1V8}
N 100 -100 310 -100 {lab=VSS}
N 310 -180 310 -100 {lab=VSS}
...
model=res_generic_m4
mult=1}
C {LELO_ATR_SKY130A/LELOATR_LVT_PCH_4C5F0.sym} 270 -210 0 0 {name=x1 }
