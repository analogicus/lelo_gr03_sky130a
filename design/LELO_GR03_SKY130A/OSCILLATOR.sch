...
S {}
E {}
T {Generating bias voltage} -850 -260 0 0 0.4 0.4 {}
...
N -650 150 -610 150 {lab=V_IB}
N -630 100 -630 150 {lab=V_IB}
N -690 100 -630 100 {lab=V_IB}
N -730 150 -690 150 {lab=VSS}
N -690 290 -690 330 {lab=VSS}
N -740 10 -710 10 {lab=VSS}
N 600 -120 600 -100 {lab=V_IB}
N -170 90 -170 110 {lab=V_IB}
N -790 -110 -730 -110 {lab=PWRUP_N_1V8_BUF}
N -690 -190 -690 -140 {lab=VDD_1V8}
N -690 -110 -660 -110 {lab=VDD_1V8}
N -660 -160 -660 -110 {lab=VDD_1V8}
N -690 -160 -660 -160 {lab=VDD_1V8}
N -690 280 -690 290 {lab=VSS}
N -790 250 -730 250 {lab=PWRUP_1V8_BUF}
N -690 250 -660 250 {lab=VSS}
N -660 250 -660 290 {lab=VSS}
N -690 290 -660 290 {lab=VSS}
N -690 180 -690 220 {lab=#net3}
N -690 -80 -690 -30 {lab=#net4}
N -690 50 -690 120 {lab=V_IB}
...
C {JNW_TR_SKY130A/JNWTR_CAPX4.sym} 450 50 2 0 {name=x3[4:0]}
...
C {devices/lab_wire.sym} -610 150 0 1 {name=p8 sig_type=std_logic lab=V_IB}
C {devices/lab_wire.sym} -740 10 2 1 {name=p13 sig_type=std_logic lab=VSS}
C {JNW_ATR_SKY130A/JNWATR_NCH_4C5F0.sym} -650 150 0 1 {name=x3}
C {JNW_TR_SKY130A/JNWTR_RPPO16.sym} -690 -30 1 0 {name=x11 }
C {devices/lab_wire.sym} -730 150 2 1 {name=p25 sig_type=std_logic lab=VSS}
...
C {devices/lab_pin.sym} -690 330 0 0 {name=l29 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} -690 -190 0 1 {name=l31 sig_type=std_logic lab=VDD_1V8}
C {devices/lab_wire.sym} -790 -110 0 0 {name=p19 sig_type=std_logic lab=PWRUP_N_1V8_BUF}
C {devices/lab_wire.sym} -790 250 0 0 {name=p7 sig_type=std_logic lab=PWRUP_1V8_BUF}
C {JNW_ATR_SKY130A/JNWATR_PCH_8C1F2.sym} -730 -110 0 0 {name=x12 }
C {JNW_ATR_SKY130A/JNWATR_NCH_8C1F2.sym} -730 250 0 0 {name=x13 }
