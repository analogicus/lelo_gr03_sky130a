...
C {devices/lab_wire.sym} -260 -110 0 0 {name=p23 sig_type=std_logic lab=VD}
...
C {devices/lab_wire.sym} -400 190 2 1 {name=p25 sig_type=std_logic lab=VSS}
