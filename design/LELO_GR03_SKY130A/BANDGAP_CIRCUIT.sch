...
N 620 180 640 180 {lab=#net2}
N 640 180 710 180 {lab=#net2}
...
N 750 -200 750 -160 {lab=#net1}
N 580 110 660 110 {lab=#net2}
N 660 110 660 180 {lab=#net2}
N -180 490 -180 530 {lab=VSS}
N 100 490 100 530 {lab=VSS}
N 40 -80 280 -80 {lab=VP}
N -400 530 290 530 {lab=VSS}
N 1110 -200 1110 -160 {lab=#net1}
N -400 -200 1150 -200 {lab=#net1}
N 950 -200 950 -160 {lab=#net1}
N 1150 -200 1260 -200 {lab=#net1}
...
N 1050 180 1070 180 {lab=#net6}
N 1110 180 1130 180 {lab=VSS}
N 1050 130 1050 180 {lab=#net6}
N 1110 110 1110 150 {lab=#net6}
N 1050 130 1110 130 {lab=#net6}
...
N 100 280 180 280 {lab=DV}
N 180 280 180 310 {lab=DV}
N 180 390 180 400 {lab=VD2}
N 100 400 180 400 {lab=VD2}
...
C {JNW_ATR_SKY130A/JNWATR_PCH_4C5F0.sym} 310 -130 0 0 {name=x17}
...
C {JNW_ATR_SKY130A/JNWATR_PCH_4C5F0.sym} -140 -30 0 1 {name=x19}
...
C {devices/lab_pin.sym} 220 350 0 1 {name=p36 sig_type=std_logic lab=VSS}
C {JNW_TR_SKY130A/JNWTR_RPPO4.sym} 180 390 3 0 {name=x2 }
